...
ifeq ($(UNAME_S),Darwin)
MINISAT_STATIC_LDFLAG :=
else
MINISAT_STATIC_LDFLAG := --static
endif
...
$(BUILD_DIR)/release/bin/$(MINISAT):		MINISAT_LDFLAGS += $(MINISAT_STATIC_LDFLAG) $(MINISAT_RELSYM)
$(BUILD_DIR)/profile/bin/$(MINISAT_CORE):	MINISAT_LDFLAGS += -pg
$(BUILD_DIR)/release/bin/$(MINISAT_CORE):	MINISAT_LDFLAGS += $(MINISAT_STATIC_LDFLAG) $(MINISAT_RELSYM)
